...
menggunakan proyeksi sentral. Standarnya adalah dari kuadran xy
positif menuju titik asal x=y=z=0, tetapi sudut=0° dilihat dari arah
sumbu y. Sudut pandang dan ketinggian dapat diubah.

Euler dapat memplot

- permukaan dengan garis bayangan dan garis datar atau rentang level,\\
- awan titik,\\
- kurva parametrik,\\
- permukaan implisit.
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-001.png}
\begin{eulerprompt}
>plot3d("x^2+x*sin(y)",-5,5,0,6*pi):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-002.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-003.png}
...
>plot3d("x^2+y^2"):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-004.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-005.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-006.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-007.png}
\begin{eulerprompt}
>plot3d("x^2+y",distance=3,zoom=1,angle=pi/2,height=0):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-008.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-009.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-010.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-011.png}
\begin{eulerprompt}
>function f(r) := exp(-r/2)*cos(r); ...
>plot3d("f(x^2+y^2)",>polar,scale=[1,1,0.4],r=pi,frame=3,zoom=4):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-012.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-013.png}
\begin{eulerprompt}
>plot3d("x^2+1",a=-1,b=1,rotate=2,grid=5):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-014.png}
\begin{eulerprompt}
>plot3d("sqrt(25-x^2)",a=0,b=5,rotate=1):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-015.png}
\begin{eulerprompt}
>plot3d("x*sin(x)",a=0,b=6pi,rotate=2):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-016.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-017.png}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-018.png}
\begin{eulerprompt}
>plot3d("exp(x*y)",angle=100°,>contour,color=green):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-019.png}
\begin{eulercomment}
Bayangan defaultnya menggunakan warna abu-abu. Namun rentang warna
spektral juga tersedia.

-\textgreater{}spektral: Menggunakan default spectral scheme\\
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-020.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-021.png}
\begin{eulerprompt}
>plot3d("x^2-y^2",0,5,0,5,level=-1:0.1:1,color=redgreen):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-022.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-023.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-025.png}
\begin{eulercomment}
Dimungkinkan untuk menampilkan bidang kontur dibawah plot. Warna dan
jarak ke plot dapat ditentukan.
\end{eulercomment}
\begin{eulerprompt}
>plot3d("x^2+y^4",>cp,cpcolor=green,cpdelta=0.2):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-026.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-027.png}
\begin{eulercomment}
Ada beberapa skema spektral lainnya, yang diberi nomor dari 1 hingga
9. Namun Anda juga dapat menggunakan warna=nilai, dimana nilai
...
>figure(0):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-028.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-029.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-030.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-031.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-032.png}
...
- implisit=1: potong sejajar bidang yz\\
- implisit=2: potong sejajar bidang xz\\
- implisit=4: potong sejajar bidang xy

Tambahkan nilai berikut, jika Anda mau. Dalam contoh kita memplot\\
\end{eulercomment}
\begin{eulerformula}
\[
 M={(x,y,z):x^2 + y^2 +zy=1}
\]
\end{eulerformula}
\begin{eulerprompt}
>plot3d("x^2+y^3+z*y-1",r=5,implicit=3):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-035.png}
\begin{eulerprompt}
>c=1; d=1;
>plot3d("((x^2+y^2-c^2)^2+(z^2-1)^2)*((y^2+z^2-c^2)^2+(x^2-1)^2)*((z^2+x^2-c^2)^2+(y^2-1)^2)-d",r=2,<frame,>implicit,>user): 
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-036.png}
\begin{eulerprompt}
>plot3d("x^2+y^2+4*x*z+z^3",>implicit,r=2,zoom=2.5):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-037.png}
...
koordinat secara efektif. Dalam contoh berikut, kita menggunakan
vektor nilai t dan vektor kolom nilai s untuk membuat parameter
permukaan bola. Dalam gambar kita dapat menandai wilayah, dalam kasus
kita wilayah kutub.
\end{eulercomment}
\begin{eulerprompt}
...
>scale=1.4,height=50°):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-039.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-040.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-042.png}
\begin{eulercomment}
...
\begin{eulerformula}
\[
0<=t<=2\pi, \frac{-\pi}{2} <=s<= \frac{\pi}{2}
\]
\end{eulerformula}
\begin{eulercomment}
Kita mensdistorsi ini dengan sebuah faktor
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-046.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-047.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-048.png}
\begin{eulerprompt}
>t=linspace(0,4pi,1000); plot3d(cos(t),sin(t),t/2pi,>wire, ...
>linewidth=3,wirecolor=blue):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-049.png}
\begin{eulerprompt}
>X=cumsum(normal(3,100)); ...
> plot3d(X[1],X[2],X[3],>anaglyph,>wire):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-050.png}
\begin{eulercomment}
EMT juga dapat membuat plot dalam model anaglyph. Untuk melihat plot
seperti itu, Anda memerlukan kacamata berwarna merah/sian.
\end{eulercomment}
\begin{eulerprompt}
> plot3d("x^2+y^3",>anaglyph,>contour,angle=30°):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-051.png}
\begin{eulercomment}
Seringkali skema warna speltral digunakan untuk plot. Ini menekankan
ketinggian fungsinya.
\end{eulercomment}
\begin{eulerprompt}
>plot3d("x^2*y^3-y",>spectral,>contour,zoom=3.2):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-052.png}
\begin{eulercomment}
Euler juga dapat memplot permukaan yang diparameterisasi, jika
parameternya adalah x, y, dan z dari gambar kotak persegi panjang
diruang tersebut. 
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-053.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-054.png}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-055.png}
\begin{eulercomment}
Dimungkinakn untuk membagi plot suatu permukaan menjadi dua bagian
atau lebih.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-056.png}
\begin{eulercomment}
Jika memuat atau menghasilkan matriks data M dari file dan perlu
memplotnya dalam 3D, Anda dapat menskalakan matriks ke [-1,1]\\
dengan skala(M), atau menskalakan matriks dengan \textgreater{}zscale. Hal ini
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-057.png}
\begin{eulerprompt}
>Z=intrandom(5,100,6); v=zeros(5,6); ...
>loop 1 to 5; v[#]=getmultiplicities(1:6,Z[#]); end; ...
>columnsplot3d(v',scols=1:5,ccols=[1:5]):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-058.png}
...
>level=[-2;0],n=100):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-059.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-064.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-065.png}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D translate_Hasna Zalfa R_22305144019-066.png}
\begin{eulercomment}
...
>myplot(x,y,z):
\end{eulerprompt}
\eulerimg{27}{images/Plot 3D translate_Hasna Zalfa R_22305144019-067.png}
...
\end{eulerprompt}
\eulerimg{27}{images/Plot 3D translate_Hasna Zalfa R_22305144019-068.png}
...
http://www.povray.org/,\\
dan meletakkan sub-direktori "bin" Povray ke\\
jalur lingkungan, atau mengatur variabel "defaultpovray" dengan jalur
...
\end{eulerprompt}
\eulerimg{27}{images/Plot 3D translate_Hasna Zalfa R_22305144019-069.png}
\begin{eulerprompt}
>pov3d("x^2+y^2",zoom=3);
\end{eulerprompt}
\eulerimg{28}{images/Plot 3D translate_Hasna Zalfa R_22305144019-070.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Plot 3D translate_Hasna Zalfa R_22305144019-071.png}
\begin{eulercomment}
...
> <fscale,zoom=3.8);
\end{eulerprompt}
\eulerimg{28}{images/Plot 3D translate_Hasna Zalfa R_22305144019-072.png}
\begin{eulerprompt}
>pov3d("((x-1)^2+y^2)*((x+1)^2+y^2)/40",r=2, ...
>  angle=-120°,level=1/40,dlevel=0.005,light=[-1,1,1],height=10°,n=50, ...
>  <fscale,zoom=3.8);
\end{eulerprompt}
\eulerimg{28}{images/Plot 3D translate_Hasna Zalfa R_22305144019-073.png}
...
\end{eulerprompt}
\eulerimg{28}{images/Plot 3D translate_Hasna Zalfa R_22305144019-074.png}
\begin{eulercomment}
...
>  w=500,h=300);
\end{eulerprompt}
\eulerimg{16}{images/Plot 3D translate_Hasna Zalfa R_22305144019-075.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{28}{images/Plot 3D translate_Hasna Zalfa R_22305144019-076.png}
\begin{eulercomment}
...
tampilan yang bagus dengan titik yang tidak terlalu banyak, kami
...
Sintaksnya adalah \&"ekspresi"(parameter). Ini adalah alternatif \\
dari metode pada contoh sebelumnya, di mana kita mendefinisikan
...
\end{eulerprompt}
\eulerimg{21}{images/Plot 3D translate_Hasna Zalfa R_22305144019-077.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{28}{images/Plot 3D translate_Hasna Zalfa R_22305144019-078.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{28}{images/Plot 3D translate_Hasna Zalfa R_22305144019-079.png}
...
kode Povray yang relevan. Kita dapat menggunakan warna default\\
...
>povend;
\end{eulerprompt}
\eulerimg{28}{images/Plot 3D translate_Hasna Zalfa R_22305144019-080.png}
\begin{eulercomment}
Fungsi berikut menghasilkan fraktal secara rekursif.


ungsi pertama menunjukkan bagaimana Euler menangani objek Povray
...
>povend();
\end{eulerprompt}
\eulerimg{28}{images/Plot 3D translate_Hasna Zalfa R_22305144019-081.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{28}{images/Plot 3D translate_Hasna Zalfa R_22305144019-082.png}
...
>povend();
\end{eulerprompt}
\eulerimg{28}{images/Plot 3D translate_Hasna Zalfa R_22305144019-084.png}
\begin{eulerprompt}
>povstart(angle=70°,height=50°,zoom=4);
\end{eulerprompt}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{28}{images/Plot 3D translate_Hasna Zalfa R_22305144019-085.png}
...
menggunakan deklarasi. Fungsi povtriangle() melakukan ini secara
...
>povend();
\end{eulerprompt}
\eulerimg{28}{images/Plot 3D translate_Hasna Zalfa R_22305144019-086.png}
...
\end{eulerprompt}
\eulerimg{27}{images/Plot 3D translate_Hasna Zalfa R_22305144019-087.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Plot 3D translate_Hasna Zalfa R_22305144019-088.png}
...
>povend(h=320,w=480);
\end{eulerprompt}
\eulerimg{18}{images/Plot 3D translate_Hasna Zalfa R_22305144019-089.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{28}{images/Plot 3D translate_Hasna Zalfa R_22305144019-092.png}
...
\end{eulerprompt}
\eulerimg{27}{images/Plot 3D translate_Hasna Zalfa R_22305144019-094.png}
\begin{eulercomment}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Plot 3D translate_Hasna Zalfa R_22305144019-096.png}
\begin{eulercomment}
\begin{eulercomment}
\eulerheading{Contoh Soal 3 }
\begin{eulercomment}
Gambarlah Grafik fungsi logaritma berikut
...
>plot3d("f"):
\end{eulerprompt}
\eulerimg{27}{images/Plot 3D translate_Hasna Zalfa R_22305144019-098.png}
\eulerheading{Contoh Soal 4}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulerprompt}
>function g(x,y) &= 3*x^2-4*x*y+2*y^2;
>plot3d("g"):
\end{eulerprompt}
\eulerimg{27}{images/Plot 3D translate_Hasna Zalfa R_22305144019-100.png}
\end{eulernotebook}
