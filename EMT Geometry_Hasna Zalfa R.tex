...
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-001.png}
\begin{eulercomment}
Hitung luas ABC:
...
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-003.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-004.png}
...
>plotSegment(L,Q,"c"):
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-005.png}
\begin{eulercomment}
...
>color(2); plotLine(k):
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-006.png}
\begin{eulercomment}
...
>plotSegment(P,L,"r"):
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-007.png}
\begin{eulerprompt}
>  
\end{eulerprompt}
...
di Maxima. Namun, kita dapat menggunakan perhitungan simbolik sekarang
\end{eulercomment}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT Geometry_Hasna Zalfa R-009-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT Geometry_Hasna Zalfa R-011-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT Geometry_Hasna Zalfa R-017-large.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-021.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-023.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-024.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-033.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT Geometry_Hasna Zalfa R-037.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-042.png}
\begin{eulercomment}
...
Jadi luas segitiga dengan a+b+c=d maksimal jika sama sisi. Kami ingin
memperolehnya secara analitis.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-050.png}
\begin{eulerprompt}
>   
\end{eulerprompt}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-051.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-053.png}
\begin{eulercomment}
Dengan menggunakan geometri, kita memperoleh rumus sederhana


atex: \textbackslash{}frac\{a\}\{\textbackslash{}sin(\textbackslash{}alpha)\}=2r
...
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-055.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-062.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-065.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-067.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-072.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-074.png}
\begin{eulercomment}
...
persamaan. Akibatnya, kami mendapatkan solusi palsu.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-076.png}
\begin{eulerprompt}
...
\begin{eulercomment}
Hal ini terinspirasi dari pembicaraan NJWildberger. Dalam bukunya
...
perhitungannya dapat dilakukan dengan kertas dan pensil saja. Anda
...
>insimg(30);
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-083.png}
\begin{eulercomment}
Tentu saja,
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-096.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
Gambar berikut dihasilkan dengan program geometri CaR, yang dapat
menggambar kuadran dan sebaran.


mage: (20) Rational\_Geometry\_CaR.png
...
\]
\end{eulerformula}
\eulersubheading{Aturan Penyebaran Riga Kali Lipat}
\begin{eulercomment}
...
atex: \textbackslash{}alpha+\textbackslash{}beta+\textbackslash{}gamma=\textbackslash{}pi

Sejak menyebarnya


atex: \textbackslash{}alpha, \textbackslash{}pi-\textbackslash{}alpha
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-124.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-129.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-134.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-138.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-139.png}
\begin{eulercomment}
Tentu saja minimum 0 dicapai di A.


\begin{eulercomment}
\eulerheading{Dua Point}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-140.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-141.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-142.png}
\begin{eulercomment}
\end{eulercomment}
\eulersubheading{Tiga Point}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-143.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-4,xmax=1,ymin=-2,ymax=2,hue=1,title="The minimum is on A");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-144.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-145.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-2,xmax=2,ymin=-2,ymax=2,hue=1,title="The Fermat point");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-146.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-147.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],points=1,add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-148.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-149.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],add=1,color=12,points=1);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-150.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-151.png}
\begin{eulercomment}
...
>\(\backslash\)plotCircle(circleWithCenter([0,u[2]],dd[2]),"");
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-155.png}
...
>povend();
\end{eulerprompt}
\eulerimg{28}{images/EMT Geometry_Hasna Zalfa R-156.png}
\begin{eulercomment}
...
dalam fungsi scene. Fungsi ini akan digunakan dua kali kemudian.
\end{eulercomment}
\begin{eulerprompt}
>povanaglyph("scene",zoom=11,center=[0,0,0.5],height=10°,angle=140°);
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-157.png}
...
\end{euleroutput}
\begin{eulercomment}
Ayo kita gunakan conroh yang besar, Tugu Jogja dan Monas Jakarta
...
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-158.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-159.png}
...
>aspect(1):
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-160.png}
\begin{eulerprompt}
...
>plotCircle(c,"Lingkaran luar segitiga ABC"):
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-161.png}
\begin{eulercomment}
2.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-162.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-163.png}
\begin{eulercomment}
3.
\end{eulercomment}
\begin{eulerprompt}
...
>aspect(1):
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-164.png}
\begin{eulerprompt}
...
>plotPoint(P,"P"):
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-165.png}
\begin{eulercomment}
Dari gambar diatas terlihat bahwa keempat garis ssudutnya bertemu di
satu titik yaitu titik p.
\end{eulercomment}
\begin{eulerprompt}
>r=norm(P-projectToLine(P,lineThrough(A,B)));
>plotCircle(circleWithCenter(P,r),"Lingkaran dalam segiempat ABCD"):
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-166.png}
\begin{eulercomment}
...
>fcontour("d2",xmin=-2,xmax=2,ymin=-3,ymax=1,hue=1):
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-167.png}
\begin{eulercomment}
...
>plot3d("d2",xmin=-2,xmax=2,ymin=-3,ymax=1):
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-168.png}
\begin{eulercomment}
Batasan ke garis PQ
\end{eulercomment}
\begin{eulerprompt}
>plot2d("abs(x+1)+abs(x-1)",xmin=-3,xmax=3):
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-169.png}
\begin{eulercomment}
5.
\end{eulercomment}
\begin{eulerprompt}
...
>fcontour("d2",xmin=-2,xmax=2,ymin=-3,ymax=1,hue=1):
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-170.png}
\begin{eulercomment}
Grafik yang lebih menarik
\end{eulercomment}
\begin{eulerprompt}
>plot3d("d2",xmin=-2,xmax=2,ymin=-3,ymax=1):
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-171.png}
\begin{eulerprompt}
>plot2d("abs(x+1)+abs(x-1)",xmin=-3,xmax=3):
\end{eulerprompt}
\eulerimg{27}{images/EMT Geometry_Hasna Zalfa R-172.png}
\end{eulernotebook}
