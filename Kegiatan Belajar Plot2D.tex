...
default memberikan ruang untuk\\
...
\end{eulerprompt}
\eulerimg{27}{images/Kegiatan Belajar Plot2D-001.png}
\begin{eulerprompt}
>reset;
\end{eulerprompt}
\begin{eulercomment}
...
>plot2d("x^4-x",grid=6):
\end{eulerprompt}
\eulerimg{27}{images/Kegiatan Belajar Plot2D-002.png}
\begin{eulerprompt}
>hold off;
>window(ow);
\end{eulerprompt}
...
\end{eulerprompt}
\eulerimg{13}{images/Kegiatan Belajar Plot2D-003.png}
\begin{eulerprompt}
>aspect();
>reset;
\end{eulerprompt}
...
uler dapat memplot plot 2D dari\\
- ekspresi \\
...
>plot2d("x^2"):
\end{eulerprompt}
\eulerimg{27}{images/Kegiatan Belajar Plot2D-004.png}
\begin{eulerprompt}
>aspect(1.5); plot2d("x^3-x"):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-005.png}
\begin{eulerprompt}
>a:=5.6; plot2d("exp(-a*x^2)/a"); insimg(30); // menampilkan gambar hasil plot setinggi 25 baris
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-006.png}
\begin{eulercomment}
...
>plot2d("x^3-x",-1,2):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-007.png}
\begin{eulerprompt}
>plot2d("sin(x)",-2*pi,2*pi): // plot sin(x) pada interval [-2pi, 2pi]
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-008.png}
\begin{eulerprompt}
>plot2d("cos(x)","sin(3*x)",xmin=0,xmax=2pi):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-009.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/Kegiatan Belajar Plot2D-010.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/Kegiatan Belajar Plot2D-011.png}
\begin{eulercomment}
...
ada contoh berikut, kita mengubah gaya kisi, menambahkan label, dan
menggunakan label vertikal untuk sumbu y.
\end{eulercomment}
\begin{eulerprompt}
>aspect(1.5); plot2d("sin(x)",0,2pi,-1.2,1.2,grid=3,xl="x",yl="sin(x)"):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-012.png}
\begin{eulerprompt}
>plot2d("sin(x)+cos(2*x)",0,4pi):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-013.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-014.png}
\begin{eulerprompt}
>plot2d("x^x",r=1.2,cx=1,cy=1):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-015.png}
\begin{eulercomment}
...
>plot2d("log(x)",-0.1,2):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-016.png}
\begin{eulercomment}
...
>plot2d("x^3-x",>square):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-017.png}
\begin{eulerprompt}
>plot2d(''integrate("sin(x)*exp(-x^2)",0,x)'',0,2): // plot integral
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-018.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-019.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-020.png}
\begin{eulerprompt}
>a:=5.6; expr &= exp(-a*x^2)/a; // define expression
>plot2d(expr,-2,2): // plot from -2 to 2
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-021.png}
\begin{eulerprompt}
>plot2d(expr,r=1,thickness=2): // plot in a square around (0,0)
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-022.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x),>add,style="--",color=red): // add another plot
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-023.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x,2),a=-2,b=2,c=-2,d=1): // plot in rectangle
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-024.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x),a=-2,b=2,>square): // keep plot square
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-025.png}
\begin{eulerprompt}
>plot2d("x^2",0,1,steps=1,color=red,n=10):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-026.png}
\begin{eulerprompt}
>plot2d("x^2",>add,steps=2,color=blue,n=10):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-027.png}
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-028.png}
\begin{eulerprompt}
>plot2d("f",0,1;0.4): // plot with a=0.4
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-029.png}
\begin{eulerprompt}
>plot2d(\{\{"f",0.2\}\},0,1): // plot with a=0.2
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-030.png}
\begin{eulerprompt}
>plot2d(\{\{"f(x,b)",b=0.1\}\},0,1): // plot with 0.1
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-031.png}
\begin{eulerprompt}
>function f(x) := x^3-x; ...
>plot2d("f",r=1):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-032.png}
\begin{eulercomment}
...
>plot2d(f,0,2):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-033.png}
\begin{eulercomment}
...
>plot2d(expr,0,3pi):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-034.png}
\begin{eulerprompt}
>function f(x) &= x^x;
>plot2d(f,r=1,cx=1,cy=1,color=blue,thickness=2);
>plot2d(&diff(f(x),x),>add,color=red,style="-.-"):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-035.png}
\begin{eulercomment}
...
arna dapat dipilih sebagai salah satu warna default, atau sebagai
warna RGB.\\
- 0..15: indeks warna default.\\
- konstanta warna: putih, hitam, merah, hijau, biru, cyan, zaitun,
abu-abu terang, abu-abu, abu-abu tua, oranye, hijau muda, pirus, biru
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-036.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/Kegiatan Belajar Plot2D-037.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/Kegiatan Belajar Plot2D-038.png}
...
\end{eulerprompt}
\eulerimg{27}{images/Kegiatan Belajar Plot2D-039.png}
\begin{eulerprompt}
>aspect(1.5); plot2d("sin(x)",0,2pi); plot2d("cos(x)",color=blue,style="--",>add):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-040.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-041.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-042.png}
\begin{eulercomment}
...
Maxima melalui ekspresi simbolik. Plot ini dilakukan dalam perintah
multi-baris berikut dengan tiga panggilan ke plot2d(). Yang kedua dan
ketiga memiliki kumpulan tanda \textgreater{}add, yang membuat plot menggunakan
rentang sebelumnya. Kita tambahkan titik perpotongan dengan label
(pada posisi "cl" untuk kiri tengah), dan masukkan hasilnya ke dalam
buku catatan.
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-044.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-046.png}
\begin{eulercomment}
...
>plot2d(x,y):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-047.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-048.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-049.png}
\begin{eulerprompt}
>plot2d(["sin(x)","cos(x)"],0,2pi): // plot vector of expressions
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-050.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-051.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-052.png}
\begin{eulercomment}
Ekspresi dan fungsi satu baris dapat melihat variabel global.


ika Anda tidak dapat menggunakan variabel global, Anda perlu
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-053.png}
\begin{eulercomment}
...
kemudian diteruskan sebagai argumen ke fungsi lain. Ekspresi dan
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-054.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-055.png}
\eulersubheading{Label Teks}
\begin{eulercomment}
Dekorasi sederhana bisa\\
berupa - judul dengan\\
title="..." - label x- dan y dengan xl="...",\\
yl="..." - label teks lain dengan label("..." ,x,y)
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-056.png}
\begin{eulerprompt}
>expr := "log(x)/x"; ...
>  plot2d(expr,0.5,5,title="y="+expr,xl="x",yl="y"); ...
>  label("(1,0)",1,0); label("Max",E,expr(E),pos="lc"):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-057.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-058.png}
\begin{eulercomment}
...
>tcolor=black,>left):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-059.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-060.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-061.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-062.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-063.png}
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-064.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-065.png}
\begin{eulercomment}
...
>  x=0.7,y=0.2):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-066.png}
\begin{eulercomment}
\end{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Kegiatan Belajar Plot2D-067.png}
\begin{eulerprompt}
>plot2d("exp(x)*sin(x)",user=true, ...
>  title="+/- or cursor keys (return to exit)"):
\end{eulerprompt}
\eulerimg{27}{images/Kegiatan Belajar Plot2D-068.png}
\begin{eulercomment}
...
ke evaluasi fungsi interp().

Tanpa ini, kita harus menulis fungsi plotinterp() terlebih dahulu,
mengakses nilainya secara global.\\
...
\end{eulerprompt}
\eulerimg{27}{images/Kegiatan Belajar Plot2D-069.png}
\begin{eulercomment}
Ada juga fungsi yang memplot fungsi lain bergantung pada vektor
parameter, dan memungkinkan pengguna menyesuaikan\\
parameter ini.\\
...
\end{eulerprompt}
\eulerimg{27}{images/Kegiatan Belajar Plot2D-070.png}
\begin{eulercomment}
...
>plotf(nd):
\end{eulerprompt}
\eulerimg{27}{images/Kegiatan Belajar Plot2D-071.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulersubheading{Style 2D Plots}
\begin{eulercomment}
...
> figure(0):
\end{eulerprompt}
\eulerimg{27}{images/Kegiatan Belajar Plot2D-072.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-073.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-074.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-076.png}
\begin{eulercomment}
Ada juga kotak teks.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-077.png}
\begin{eulerprompt}
>plot2d(["exp(x)","1+x"],color=[black,blue],style=["-","-.-"]):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-078.png}
\begin{eulerprompt}
...
> reset():
\end{eulerprompt}
\eulerimg{27}{images/Kegiatan Belajar Plot2D-079.png}
\begin{eulercomment}
...
> reset:
\end{eulerprompt}
\eulerimg{27}{images/Kegiatan Belajar Plot2D-080.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-081.png}
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-082.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-083.png}
\begin{eulerprompt}
>p=polyfit(xdata,ydata,1); // get regression line
>plot2d("polyval(p,x)",>add,color=red): // add plot of line
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-084.png}
\begin{eulercomment}
Plot data sebenarnya berbentuk poligon. Kita juga dapat memplot kurva
atau kurva terisi.\\
- filled=true mengisi plot.\\
- style="...": Pilih dari "#", "/", "\textbackslash{}", "\textbackslash{}/".\\
- fillcolor: Lihat di atas untuk mengetahui warna
...
>figure(0):
\end{eulerprompt}
\eulerimg{14}{images/Kegiatan Belajar Plot2D-085.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/Kegiatan Belajar Plot2D-086.png}
\begin{eulerprompt}
>t=linspace(0,2pi,6); ...
>plot2d(cos(t),sin(t),>filled,style="/",fillcolor=red,r=1.2):
\end{eulerprompt}
\eulerimg{14}{images/Kegiatan Belajar Plot2D-087.png}
\begin{eulerprompt}
>t=linspace(0,2pi,6); plot2d(cos(t),sin(t),>filled,style="#"):
\end{eulerprompt}
\eulerimg{14}{images/Kegiatan Belajar Plot2D-088.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/Kegiatan Belajar Plot2D-089.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/Kegiatan Belajar Plot2D-090.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/Kegiatan Belajar Plot2D-091.png}
\begin{eulercomment}
...
> plot2d(t,t,add=true):
\end{eulerprompt}
\eulerimg{14}{images/Kegiatan Belajar Plot2D-092.png}
\begin{eulercomment}
...
>plot2d(t,y):
\end{eulerprompt}
\eulerimg{14}{images/Kegiatan Belajar Plot2D-093.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/Kegiatan Belajar Plot2D-094.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/Kegiatan Belajar Plot2D-096.png}
\begin{eulerprompt}
>plot2d("cos(x)","sin(x)^3",xmin=0,xmax=2pi,>filled,style="/"):
\end{eulerprompt}
\eulerimg{14}{images/Kegiatan Belajar Plot2D-097.png}
...
\end{eulerprompt}
\eulerimg{14}{images/Kegiatan Belajar Plot2D-099.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/Kegiatan Belajar Plot2D-100.png}
\begin{eulerprompt}
>t=linspace(0,1,1000); r=exp(-t); x=r*cos(2pi*t); y=r*sin(2pi*t);
>plot2d(x,y,r=1):
\end{eulerprompt}
\eulerimg{14}{images/Kegiatan Belajar Plot2D-101.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/Kegiatan Belajar Plot2D-104.png}
...
\end{eulerprompt}
\eulerimg{27}{images/Kegiatan Belajar Plot2D-105.png}
\begin{eulerprompt}
>aspect(1.25); r=linspace(0,1,50); a=linspace(0,2pi,200)'; z=r*exp(I*a);
>plot2d(exp(z),cgrid=[40,10]):
\end{eulerprompt}
\eulerimg{21}{images/Kegiatan Belajar Plot2D-106.png}
\begin{eulerprompt}
>r=linspace(0,1,10); a=linspace(0,2pi,40)'; z=r*exp(I*a);
>plot2d(exp(z),>points,>add):
\end{eulerprompt}
\eulerimg{21}{images/Kegiatan Belajar Plot2D-107.png}
\begin{eulercomment}
Vektor bilangan kompleks secara otomatis diplot sebagai kurva pada
bidang kompleks dengan bagian nyata dan bagian imajiner.


ontoh, kita memplot lingkaran satuan dengan 
...
\end{eulerprompt}
\eulerimg{21}{images/Kegiatan Belajar Plot2D-109.png}
...
\end{eulerprompt}
\eulerimg{21}{images/Kegiatan Belajar Plot2D-110.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/Kegiatan Belajar Plot2D-111.png}
\begin{eulerprompt}
>columnsplot(cumsum(random(10)),style="/",color=blue):
\end{eulerprompt}
\eulerimg{21}{images/Kegiatan Belajar Plot2D-112.png}
\begin{eulercomment}
...
>title("Temperature"):
\end{eulerprompt}
\eulerimg{21}{images/Kegiatan Belajar Plot2D-113.png}
\begin{eulerprompt}
>k=0:10;
>plot2d(k,bin(10,k),>bar):
\end{eulerprompt}
\eulerimg{21}{images/Kegiatan Belajar Plot2D-114.png}
\begin{eulerprompt}
>plot2d(k,bin(10,k)); plot2d(k,bin(10,k),>points,>add):
\end{eulerprompt}
\eulerimg{21}{images/Kegiatan Belajar Plot2D-115.png}
\begin{eulerprompt}
>plot2d(normal(1000),normal(1000),>points,grid=6,style=".."):
\end{eulerprompt}
\eulerimg{21}{images/Kegiatan Belajar Plot2D-116.png}
\begin{eulerprompt}
>plot2d(normal(1,1000),>distribution,style="O"):
\end{eulerprompt}
\eulerimg{21}{images/Kegiatan Belajar Plot2D-117.png}
\begin{eulerprompt}
>plot2d("qnormal",0,5;2.5,0.5,>filled):
\end{eulerprompt}
\eulerimg{21}{images/Kegiatan Belajar Plot2D-118.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/Kegiatan Belajar Plot2D-119.png}
\begin{eulercomment}
...
>plot2d(x,y,>bar):
\end{eulerprompt}
\eulerimg{21}{images/Kegiatan Belajar Plot2D-120.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/Kegiatan Belajar Plot2D-121.png}
\begin{eulerprompt}
>n=10; i=0:n; ...
>plot2d(i,bin(n,i)/2^n,a=0,b=10,c=0,d=0.3); ...
>plot2d(i,bin(n,i)/2^n,points=true,style="ow",add=true,color=blue):
\end{eulerprompt}
\eulerimg{21}{images/Kegiatan Belajar Plot2D-122.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/Kegiatan Belajar Plot2D-123.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/Kegiatan Belajar Plot2D-124.png}
\begin{eulerprompt}
>k=0:10; m=bin(10,k); x=(0:11)-0.5; plot2d(x,m,>bar):
\end{eulerprompt}
\eulerimg{21}{images/Kegiatan Belajar Plot2D-125.png}
\begin{eulerprompt}
>columnsplot(m,k):
\end{eulerprompt}
\eulerimg{21}{images/Kegiatan Belajar Plot2D-126.png}
\begin{eulerprompt}
>plot2d(random(600)*6,histogram=6):
\end{eulerprompt}
\eulerimg{21}{images/Kegiatan Belajar Plot2D-127.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/Kegiatan Belajar Plot2D-128.png}
\begin{eulercomment}
Dengan parameter even=treu, ini akan menggunakan interval bilangan
bulat.
\end{eulercomment}
\begin{eulerprompt}
>plot2d(intrandom(1,1000,10),distribution=10,even=true):
\end{eulerprompt}
\eulerimg{21}{images/Kegiatan Belajar Plot2D-129.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/Kegiatan Belajar Plot2D-130.png}
\begin{eulerprompt}
>plot2d(normal(1,1000),>distribution); ...
>  plot2d("qnormal(x)",color=red,thickness=2,>add):
\end{eulerprompt}
\eulerimg{21}{images/Kegiatan Belajar Plot2D-131.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/Kegiatan Belajar Plot2D-132.png}
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-134.png}
\begin{eulerprompt}
>expr := "2*x^2+x*y+3*y^4+y"; // define an expression f(x,y)
>plot2d(expr,level=0): // Solutions of f(x,y)=0
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-135.png}
\begin{eulerprompt}
>plot2d(expr,level=0:0.5:20,>hue,contourcolor=white,n=200): // nice
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-136.png}
\begin{eulerprompt}
>plot2d(expr,level=0:0.5:20,>hue,>spectral,n=200,grid=4): // nicer
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-137.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-138.png}
\begin{eulerprompt}
>plot2d("x^3-y^2",>contour,>hue,>spectral):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-139.png}
\begin{eulerprompt}
>plot2d("x^3-y^2",level=0,contourwidth=3,>add,contourcolor=red):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-140.png}
\begin{eulerprompt}
>z=z+normal(size(z))*0.2;
>plot2d(z,level=0.5,a=-1,b=2,c=-2,d=1):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-141.png}
\begin{eulerprompt}
>plot2d(expr,level=[0:0.2:5;0.05:0.2:5.05],color=lightgray):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-142.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=1,r=4,n=100):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-143.png}
\begin{eulerprompt}
>plot2d("x^2+2*y^2-x*y",level=0:0.1:10,n=100,contourcolor=white,>hue):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-144.png}
\begin{eulercomment}
...
>plot2d(expr,level=[0;1],style="-",color=blue): // 0 <= f(x,y) <= 1
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-146.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-147.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=[0,2,4;1,3,5],style="/",r=2,n=100):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-148.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=-10:20,r=2,style="-",dl=0.1,n=100):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-149.png}
\begin{eulerprompt}
>plot2d("sin(x)*cos(y)",r=pi,>hue,>levels,n=100):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-150.png}
\begin{eulercomment}
...
>  level=[-2;0],n=100):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-152.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-154.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/Kegiatan Belajar Plot2D-155.png}
\begin{eulercomment}
...
>logimpulseplot1(x,y):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-156.png}
\begin{eulercomment}
Mari kita menganimasikan kurva 2D menggunakan plot langsung. Perintah
plot(x,y) hanya memplot kurva ke dalam jendela plot.
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-157.png}
\begin{eulerprompt}
>plot2d("exp(x+sin(x))",0,100,logplot=1):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-158.png}
\begin{eulerprompt}
>plot2d("exp(x+sin(x))",10,100,logplot=2):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-159.png}
\begin{eulerprompt}
>plot2d("gamma(x)",1,10,logplot=1):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-160.png}
\begin{eulerprompt}
>plot2d("log(x*(2+sin(x/100)))",10,1000,logplot=3):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-161.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-162.png}
...
\begin{eulerformula}
\[
f(x)=x^5+3x^4-2x^2-x+20
\]
\end{eulerformula}
\begin{eulerprompt}
>plot2d("x^5+3*x^4-2*x^2-x+20",-20,20):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-164.png}
\begin{eulercomment}
2. Buatlah Grafik fungsi berikut

\end{eulercomment}
\begin{eulerformula}
\[
f(x)=sin^2{x}+sin{x}+\frac{1}{sin{x}}
\]
\end{eulerformula}
\begin{eulerprompt}
>plot2d("(sin(x))^2+sin(x)+1/sin(x)",0,15):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-166.png}
\begin{eulercomment}
3. Tunjukan titik potong dari kedua fungsi dibawah ini dan gambarkan
grafiknya
...
\end{eulerformula}
\begin{eulerprompt}
>plot2d(["x^2-2","x+2"],r=4,cx=0.5,cy=1,...
>color=[black,blue],style=["-","."],...
>grid=1):
\end{eulerprompt}
\eulerimg{17}{images/Kegiatan Belajar Plot2D-169.png}
