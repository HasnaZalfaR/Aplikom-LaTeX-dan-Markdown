...
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-001.png}
\begin{eulercomment}
Kami menghitung probabilitas suatu nilai lebih besar dari 1005, dengan
asumsi nilai terukur dan berdistribusi normal.
...
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-002.png}
\begin{eulercomment}
...
berisi tiga kolom: Mulai dari rentang, akhir jangkauan, jumlah pria
dalam jangkauan.
...
kita perlu menghitung titik tengah rentang tersebut. Kami dapat
menggunakan dua kolom pertama tabel kami untuk ini.
...
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-003.png}
\eulerheading{Tables}
\begin{eulercomment}
Di direktori buku catatan ini Anda menemukan file dengan tabel. Data
tersebut merupakan hasil survei. Di Sini adalah empat baris pertama
file. Datanya berasal dari buku online Jerman "Einführung in die
...
tabel dari file. Pertama, kita gunakan terjemahan kami sendiri untuk
tokennya.
...
Argumen tok2, tok4 dll. adalah terjemahan dari kolom tabel.
...
Jika kita tidak ingin menentukan token untuk terjemahannya terlebih
dahulu, kita hanya perlu menentukan, kolom yang mana berisi token dan
bukan angka.
\end{eulercomment}
\begin{eulerprompt}
...
ika kita tidak ingin menentukan token untuk terjemahannya terlebih
dahulu, kita hanya perlu menentukan, kolom yang mana berisi token dan
bukan angka.
\end{eulercomment}
\begin{eulerprompt}
...
mendapatkan NAN (bukan angka) di tabel. Ini terjemahan dapat diubah
...
file, kita dapat mencetak tabel. Kita bisa menentukannya ctok, tok,
dll atau gunakan tabel daftar.
\end{eulercomment}
\begin{eulerprompt}
...
apa pun dengan nilai NAN("." di file), dan indeks kolom, yang berisi
nilai-nilai ini.
\end{eulercomment}
\begin{eulerprompt}
>\{c,i\}=tablecol(MT,[5,6]);
...
jumlahnya. Kami menerapkannya pada "m" dan "f" nilai di kolom kedua
tabel kami.
\end{eulercomment}
\begin{eulerprompt}
...
Jadi kami mengekstrak kolom 2 dan 4 dan mengurutkannya tabel.
\end{eulercomment}
\begin{eulerprompt}
>i=sortedrows(MT,[2,4]);  ...
...
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-004.png}
\begin{eulercomment}
Perlu diperhatikan perbedaan antara bar plot (sampel) dan kurva normal
distribusi sebenarnya). Masuk kembali ketiga perintah tersebut untuk
melihat hasil sampling lainnya.
\end{eulercomment}
\begin{eulercomment}
Berikut adalah perbandingan 10 simulasi dari 1000 nilai terdistribusi
normal menggunakan apa yang disebut plot kotak. alur cerita ini
...
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-005.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-006.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-007.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-008.png}
\begin{eulercomment}
Berikut ini adalah salah satu cara untuk memplot kuantil.\\
ribusi dan inversnya.
\end{eulercomment}
\begin{eulerprompt}
>plot2d("qnormal(x,1,1.5)",-4,6);  ...
>plot2d("qnormal(x,1,1.5)",a=2,b=5,>add,>filled):
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-009.png}
\begin{eulerformula}
\[
\text{normaldis(x,m,d)}=\int_{-\infty}^x \frac{1}{d\sqrt{2\pi}}e^{-\frac{1}{2}(\frac{t-m}{d})^2}\ dt.
\]
...
Euler memetakan vektor ke fungsi ini.\\
Dengan demikian kita mendapatkan plot semua distribusi chi-kuadrat
dengan derajat 5 sampai 30 dengan mudah dengan cara berikut.
\end{eulercomment}
\begin{eulerprompt}
>plot2d("qchidis(x,(5:5:50)')",0,50):
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-010.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-011.png}
\begin{eulercomment}
...
Namun untuk n yang besar, penjumlahan langsungnya adalah tidak akurat
dan lambat.
\end{eulercomment}
\begin{eulerprompt}
...
(26 kartu). Mari kita hitung kemungkinannya dari distribusi yang lebih
...
adalah kursi masing-masing partai, dan kolom 2 adalah jumlah kursinya.
Jumlah tempat duduk. kolom adalah tahun pemilihan.
\end{eulercomment}
\begin{eulerprompt}
...
nama sebagai header kolom, dan tahun sebagai header baris. Lebar
default untuk kolom adalah wc=10, tetapi kami lebih memilih keluaran
yang lebih padat. Kolomnya akan menjadi diperluas untuk label kolom,
jika perlu.
\end{eulercomment}
\begin{eulerprompt}
...
besar yang menunjukkan hal itu partai-partai kecil telah mendapatkan
dukungan di parlemen hingga tahun 2009.
\end{eulercomment}
\begin{eulerprompt}
...
dengan panggil plot2d dua kali dengan \textgreater{}add.
\end{eulercomment}
\begin{eulerprompt}
>statplot(YT,BT1,"b"):
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-012.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-013.png}
\begin{eulercomment}
Plot data menggabungkan deretan data statistik dalam satu plot.\\
jadi satu plot dengan menggunakan gambar. Kita dapat menambahkan
vektor kolom ke setiap plot.
\end{eulercomment}
\begin{eulerprompt}
>J:=BW[,1]'; DP:=BW[,3:7]'; ...
...
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-014.png}
\begin{eulercomment}
...
>  angle=30°,ccols=CP):
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-015.png}
\begin{eulercomment}
...
>shrinkwindow():
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-016.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-017.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-018.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-019.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-020.png}
\begin{eulercomment}
...
Namun untuk data yang terdistribusi secara eksponensial, kita mungkin
memerlukan plot logaritmik. Ini adalah aplikasi lain, di mana kita
menghitung karakter dalam sebuah kalimat dan membuat statistik.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-021.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-022.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-023.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-024.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-025.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-026.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-027.png}
...
>figure(0):
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-028.png}
\begin{eulercomment}
Contoh lain kita membaca survei terhadap siswa, usia mereka, usia
orang tua mereka dan jumlah siswa saudara kandung dari sebuah file.
...
dari st. Ini adalah perbedaan usia rata-rata antara ayah dan ibu.
\end{eulercomment}
\begin{eulerprompt}
>da:=mean(cs[2]-cs[1])
\end{eulerprompt}
...
\end{euleroutput}
\begin{eulercomment}
Menariknya, perbedaan median tidak sebesar perbedaan artinya.
\end{eulercomment}
\begin{eulerprompt}
...
baru. Misalnya, kita mendefinisikan fungsi.
...
ah mean dari st. Ini adalah perbedaan usia rata-rata antara ayah dan
ibu.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-029.png}
\begin{eulercomment}
...
bedaan usia rata-rata antara ayah dan ibu.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-030.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-031.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-032.png}
\eulerheading{Tests}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-033.png}
\begin{eulerprompt}
>t=count(R,21);
\end{eulerprompt}
\begin{eulercomment}
...
chi\textasciicircum{}2 melakukan hal ini. Hasilnya adalah cara untuk melakukannya besar
untuk menolak kemerdekaan. Jadi kita tidak bisa bilang, kalau voting
tergantung jenis kelamin dari data tersebut.
\end{eulercomment}
\begin{eulerprompt}
>tabletest(A)
\end{eulerprompt}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-034.png}
\begin{eulercomment}
Hapus datanya
\end{eulercomment}
\begin{eulerprompt}
...
otebook ini cocok untuk Anda yang sudah familiar dengan R, namun perlu
mengetahui perbedaan sintaksis EMT dan R. Kami mencoba memberikan
gambaran umum tentang hal-hal yang sudah jelas dan kurang jelas yang
perlu Anda ketahui. Selanjutnya kita hitung jarak antara dua angka
yang kurang dari 0,05. Selain itu, kami mencari cara untuk bertukar
data antara kedua sistem.
\end{eulercomment}
\begin{eulercomment}
...
amun EMT akan menafsirkan indeks negatif dari belakang vektor,
...
terdapat vektor yang berkembang. Anda dapat mengatur kosongkan vektor
numerik v dan berikan nilai pada elemen v[17]. Hal ini tidak mungkin
dilakukan di EMT.
...
aktor-faktor tersebut harus disimpan dengan jelas dalam kumpulan jenis
dan kategori (negara bagian dan teritori dalam contoh kita). Untuk
EMT, kami menambahkan indeks yang telah dihitung sebelumnya.
\end{eulercomment}
\begin{eulerprompt}
>function makef (t) ...
\end{eulerprompt}
...
matriks. Akan mudah untuk menulis namun berfungsi untuk dimensi yang
...
ke suatu nilai. Hal yang sama juga mungkin terjadi di EMT hanya dengan
satu lingkaran.
\end{eulercomment}
\begin{eulerprompt}
...
dengan referensi di EMT. Jika Anda tidak ingin berubah matriks asli M,
Anda perlu menyalinnya ke dalam fungsi.
\end{eulercomment}
\begin{eulerprompt}
...
\end{euleroutput}
\begin{eulercomment}
Dalam PDF pengantar untuk R terdapat contoh yang menghitung distribusi
ab-cd untuk a,b,c,d dipilih dari 0 hingga n secara acak. Solusi dalam
...
efektif di EMT atau R. Di EMT, kita bisa\\
tulis loop dalam C dan itu akan menjadi solusi tercepat.

Namun kita ingin meniru perilaku R. Untuk melakukannya, kita perlu
meratakan perkalian ab dan membuat a matriks ab-cd.
\end{eulercomment}
\begin{eulerprompt}
...
>statplot(u,f,"h"):
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-035.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-036.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-037.png}
\eulerheading{Lists}
\begin{eulercomment}
...
eri nomor dan tidak diberi nama.
\end{eulercomment}
\begin{eulerprompt}
...
\begin{euleroutput}
  A,B,C
  0.6097034433972056,0.8128114520055117,0.3538388912921333
  0.9952608205364876,0.7952277537409026,0.9248815642739334
  0.06033503549568263,0.08225322328113205,0.007283414071002135
...
\begin{euleroutput}
           A         B         C
      0.6097   0.81281   0.35384
     0.99526   0.79523   0.92488
     0.06034   0.08225   0.00728
\end{euleroutput}
\begin{eulercomment}
...
\end{eulerprompt}
\begin{euleroutput}
  0.5555311987270377,0.7510785562180342,0.05645731547794855
  0.5915613706608845,0.2914407620078254,0.4332344093476072
  0.7878738646252447,0.9478747833377479,0.3089935692327346
  
\end{euleroutput}
\begin{eulercomment}
CVS ini dapat dibuka pada sistem berbahasa Inggris ke Excel dengan
klik dua kali. Jika Anda mendapatkan file seperti itu di a. Sistem
...
dapat membaca matriks dari file dengan readma-trix().
\end{eulercomment}
\begin{eulerprompt}
>readmatrix(file)
\end{eulerprompt}
\begin{euleroutput}
    0.55553   0.75108  0.056457 
    0.59156   0.29144   0.43323 
    0.78787   0.94787   0.30899 
\end{euleroutput}
\begin{eulercomment}
Dimungkinkan untuk menulis beberapa matriks ke satu file. Perintah
open() dapat membuka file untuk menulis parameter "w". Standarnya
adalah "r" untuk membaca.\\
or data ke Excel dengan memperhatikan titik desimal.
...
sebagai CSV (nilai yang dipisahkan koma). Pada Excel 2007, gunakan
“save as” dan “other format”, lalu pilih “CSV”. Pastikan tabel saat
ini hanya berisi data yang ingin Anda ekspor.
...
\end{eulerprompt}
\eulerimg{15}{images/EMT Statistika-038.png}
\begin{eulercomment}
...
ini mengharapkan titik desimal. Namun bisa juga menggunakan koma
...
\end{eulerprompt}
\begin{euleroutput}
    0.55553         0   0.75108         0  0.056457 
    0.59156         0   0.29144         0   0.43323 
    0.78787         0   0.94787         0   0.30899 
\end{euleroutput}
\begin{eulercomment}
...
Misalnya kita menulis tabel dengan baris dan header kolom ke file.
\end{eulercomment}
\begin{eulerprompt}
...
- string apa pun yang tidak mengandung tanda kurung dengan sub-cocokan
"(...)",\\
...
alam contoh, kita membaca versi saat ini dari situs EMT. Kami
...
\begin{euleroutput}
  M = [ ..
  0.523528228281019, 0.492936924518849;
  0.9573306689844965, 0.6392112790294731];
\end{euleroutput}
\begin{eulercomment}
...
\end{eulerprompt}
\begin{euleroutput}
  [0.083038,  0.64289,  0.025632,  0.69838,  0.32238]
\end{euleroutput}
\begin{eulercomment}
\begin{eulercomment}
...
\begin{eulercomment}
\end{eulercomment}
\eulersubheading{Soal 1 (Mean)}
\begin{eulercomment}
Di bawah ini terdapat data jumlah siswa kelas 7 SMP Rukun. Terdapat 4
kelas 7 di SMP Rukun, dengan jumlah siswa laki-laki dan perempuan yang
tidak merata.

Jenis Kelamin   Kelas7A   Kelas7B   Kelas7C   Kelas7D\\
Perempuan          18        17        11        10\\
Laki-laki          12        13        19        15

Hitung rata-rata jumlah siswa laki-laki dan rata-rata jumlah siswa
perempuan kelas 7 SMP Rukun!

- Mean jumlah siswa laki-laki
\end{eulercomment}
\begin{eulerprompt}
>x=[12,13,19,15]; mean(x),
\end{eulerprompt}
\begin{euleroutput}
  14.75
\end{euleroutput}
...
\end{eulerformula}
\begin{eulercomment}
Sehingga rata-rata jumlah anak laki-laki adalah 14,75

- Mean jumlah siswa perempuan
\end{eulercomment}
\begin{eulerprompt}
>x=[18,17,11,10]; mean(x),
\end{eulerprompt}
\begin{euleroutput}
  14
\end{euleroutput}
...
\end{eulerformula}
\begin{eulercomment}
Sehingga rata-rata jumlah anak perempuan adalah 14


\end{eulercomment}
\eulersubheading{Soal 2 (Median Data Tunggal)}
\begin{eulercomment}
Data berat badan (kg) siswa kelas VI SD Suka Maju adalah sebagai
berikut:\\
32, 34, 34, 33, 34, 33, 32, 35, 34, 32, 33, 34, 34, 32, 33, 34, 32,
33, 33, 34, 40\\
Tentukan median dari data di atas!
\end{eulercomment}
\begin{eulerprompt}
>data=[32, 34, 34, 33, 34, 33, 32, 35, 34, 32, 33, 34, 34, 32, 33, 34, 32, 33, 33, 34, 40];
>urut=sort(data)
\end{eulerprompt}
\begin{euleroutput}
  [32,  32,  32,  32,  32,  33,  33,  33,  33,  33,  33,  34,  34,  34,
  34,  34,  34,  34,  34,  35,  40]
\end{euleroutput}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
Jadi nilai tengah dari data berat badan siswa kelas VI SD Suka Maju
adalah 33
\end{eulercomment}
\begin{eulercomment}

\end{eulercomment}
\eulersubheading{Soal 3(Modus)}
\begin{eulercomment}
Berikut adalah data hasil dari pengukuran berat badan 40 siswa SD
Negeri Tambakrejo. Dari ke 40 siswa, mayoritas siswa memiliki berat
badan yang ideal.\\
Siswa yang mempunyai berat badan dalam rentang 21-25 kg sebanyak 3
orang,\\
yang mempunyai berat badan dalam rentang 26-30 kg sebanyak 10 orang,\\
yang mempunyai berat badan dalam rentang 31-35 kg sebanyak 7 orang,\\
yang mempunyai berat badan dalam rentang 36-40 kg sebanyak 8 orang,\\
yang mempunyai berat badan dalam rentang 41-45 kg sebanyak 7 orang,\\
dan yang mempunyai berat badan 46-50 kg sebanyak 5 orang.\\
Tentukan modus dari data hasil pengukuran berat badan 40 siswa di SD
tersebut!\\
Penyelesaian:\\
...
\end{euleroutput}
\begin{eulercomment}
Berdasarkan data, modus berada pada kelas 35.5-30.5
\end{eulercomment}
\begin{eulerprompt}
>Tb=25.5, p=5, d1=7, d2=3
\end{eulerprompt}
\begin{euleroutput}
  25.5
  5
...
\end{euleroutput}
\begin{eulercomment}
Jadi modus dari data hasil pengukuran berat badan 40 siswa di SD
Tambakrejo adalah 29
\end{eulercomment}
\begin{eulercomment}

\end{eulercomment}
\eulersubheading{Soal 4 (Distribusi Frekuensi)}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT Statistika-043.png}
\eulersubheading{Soal 5 (Median Data Kelompok)}
\begin{eulercomment}
